    ...
    <ProtectedRoute currentPath="/member-transparency" requiredRoles={[USER_ROLES.MEMBER]}>
      <main className="min-h-screen bg-slate-50 pb-16 dark:bg-slate-950">
        ...
        <div className="mx-auto max-w-6xl space-y-6 px-4 py-8 sm:px-6">
          <section className="rounded-3xl bg-gradient-to-br from-blue-950 via-blue-800 to-cyan-600 p-7 text-white shadow-xl"><ShieldCheck size={28}/><h2 className="mt-4 text-3xl font-black">Real figures only</h2><p className="mt-2 max-w-3xl text-sm text-blue-50">NCDFCOOP will publish cooperative financial statements only after they are formally approved and stored by authorized administrators. This page does not invent revenue, dividends, or personal distributions.</p></section>
