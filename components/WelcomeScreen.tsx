      ...
      <footer className="bg-[#041f1a] text-emerald-50">
        <div className="mx-auto max-w-[1440px] px-4 py-14 sm:px-6 lg:px-10">
          <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-[1.4fr_1fr_1fr_1fr]">
            ...
            <div><h3 className="font-black !text-white">Marketplace</h3><div className="mt-4 grid gap-3 text-sm"><a href="#marketplace" className="!text-white hover:!text-amber-200">Browse products</a><a href="#for-everyone" className="!text-white hover:!text-amber-200">For members</a><a href="#for-everyone" className="!text-white hover:!text-amber-200">For wholesale buyers</a><a href="#for-everyone" className="!text-white hover:!text-amber-200">For sellers</a></div></div>
            <div><h3 className="font-black !text-white">Platform</h3><div className="mt-4 grid gap-3 text-sm"><a href="#how-it-works" className="!text-white hover:!text-amber-200">How it works</a><a href="#trust" className="!text-white hover:!text-amber-200">Trust and controls</a><Link href="/signin" className="!text-white hover:!text-amber-200">Sign in</Link><Link href="/signup" className="!text-white hover:!text-amber-200">Create account</Link></div></div>
            <div><h3 className="font-black !text-white">Legal & support</h3><div className="mt-4 grid gap-3 text-sm"><Link href="/privacy" className="!text-white hover:!text-amber-200">Privacy policy</Link><Link href="/terms" className="!text-white hover:!text-amber-200">Terms of service</Link><a href="mailto:support@ncdfcoop.com" className="!text-white hover:!text-amber-200">Contact support</a><Link href="/forgot-password" className="!text-white hover:!text-amber-200">Recover account</Link></div></div>
          </div>
